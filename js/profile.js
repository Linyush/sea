...
'sps':'<svg viewBox="0 0 80 80"><path d="M40 18c0 14 0 20 0 20" stroke="currentColor" stroke-width="4" stroke-linecap="round" opacity=".5"/><path d="M32 20c2 12 4 22 4 22M48 20c-2 12-4 22-4 22M26 22c3 10 8 18 8 18M54 22c-3 10-8 18-8 18" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" opacity=".7"/><path d="M40 62c0-14 0-20 0-20" stroke="currentColor" stroke-width="4" stroke-linecap="round" opacity=".5"/><path d="M32 60c2-12 4-22 4-22M48 60c-2-12-4-22-4-22M26 58c3-10 8-18 8-18M54 58c-3-10-8-18-8-18" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" opacity=".7"/><circle cx="40" cy="40" r="5" fill="currentColor"/><circle cx="36" cy="38" r="4" fill="currentColor" opacity=".7"/><circle cx="44" cy="38" r="4" fill="currentColor" opacity=".7"/><circle cx="32" cy="42" r="3.5" fill="currentColor" opacity=".6"/><circle cx="48" cy="42" r="3.5" fill="currentColor" opacity=".6"/><circle cx="40" cy="37" r="2" fill="#fff" opacity=".5"/><circle cx="36" cy="36" r="1.5" fill="#fff" opacity=".4"/><circle cx="44" cy="36" r="1.5" fill="#fff" opacity=".4"/></svg>',
