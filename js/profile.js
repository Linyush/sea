...
const P_ICON_NAMES={pump:'水泵',light:'灯',wave:'造浪',skimmer:'蛋分',heater:'加热棒',chiller:'冷水机',thermo:'温度计',doser:'滴定泵',reactor:'钙反',beansoup:'煮豆机',ato:'补水器',uv:'杀菌灯',roller:'滤布机',feeder:'喂食器',tester:'检测',socket:'智能插座',other_eq:'其他',sertank:'串联缸',coralrack:'珊瑚支架',tool:'工具',airpump:'增氧设备',scape:'造景',cabinet:'柜子',salinity:'盐度计',fish:'鱼',coral:'珊瑚',invert:'无脊椎',algae:'藻',other_live:'其他',salt:'海盐',food:'鱼粮',additive:'添加剂',reagent:'试剂',medicine:'药品',other_cm:'其他',adsorbent:'吸附剂',media:'滤材',package:'包装',board:'板材',glue:'胶水',tubing:'水管',frag:'珊瑚基座',filterbag:'滤袋',filtercotton:'滤棉',filtercloth:'滤布'};
