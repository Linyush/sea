...
'sps':'<svg viewBox="0 0 80 80"><path d="M40 62c0-14 0-20 0-20" stroke="currentColor" stroke-width="4" stroke-linecap="round" opacity=".5"/><path d="M32 60c2-12 4-22 4-22M48 60c-2-12-4-22-4-22M26 58c3-10 8-18 8-18M54 58c-3-10-8-18-8-18" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" opacity=".7"/><circle cx="40" cy="20" r="5" fill="currentColor"/><circle cx="36" cy="18" r="4" fill="currentColor" opacity=".7"/><circle cx="44" cy="18" r="4" fill="currentColor" opacity=".7"/><circle cx="32" cy="22" r="3.5" fill="currentColor" opacity=".6"/><circle cx="48" cy="22" r="3.5" fill="currentColor" opacity=".6"/><circle cx="26" cy="30" r="3.5" fill="currentColor" opacity=".6"/><circle cx="54" cy="30" r="3.5" fill="currentColor" opacity=".6"/><circle cx="40" cy="17" r="2" fill="#fff" opacity=".5"/><circle cx="36" cy="16" r="1.5" fill="#fff" opacity=".4"/><circle cx="44" cy="16" r="1.5" fill="#fff" opacity=".4"/></svg>',

'soft':'<svg viewBox="0 0 80 80"><path d="M24 50c0 6 7 10 16 10s16-4 16-10" fill="currentColor" opacity=".5"/><path d="M20 38c0-3 9-6 20-6s20 3 20 6c0 5-4 12-8 14-3 2-7 3-12 3s-9-1-12-3c-4-2-8-9-8-14z" fill="currentColor"/><path d="M22 36c2-2 10-4 18-4s16 2 18 4c-1 2-3 3-6 3-4 0-7-2-12-2s-8 2-12 2c-3 0-5-1-6-3z" fill="#fff" opacity=".25"/><path d="M26 40c3 1 8 1 14 1s11 0 14-1" stroke="#fff" stroke-width="1" opacity=".2" fill="none"/></svg>',
...
'gorgonian':'<svg viewBox="0 0 80 80"><rect x="37" y="56" width="6" height="8" rx="2" fill="currentColor" opacity=".5"/><path d="M40 56V34M34 54l-6-16M46 54l6-16M30 50l-6-12M50 50l6-12M36 52l-4-14M44 52l4-14" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><circle cx="40" cy="32" r="2.5" fill="currentColor"/><circle cx="28" cy="36" r="2" fill="currentColor"/><circle cx="52" cy="36" r="2" fill="currentColor"/><circle cx="24" cy="36" r="2" fill="currentColor" opacity=".8"/><circle cx="56" cy="36" r="2" fill="currentColor" opacity=".8"/><circle cx="32" cy="36" r="2" fill="currentColor"/><circle cx="48" cy="36" r="2" fill="currentColor"/><circle cx="36" cy="34" r="1.5" fill="currentColor" opacity=".7"/><circle cx="44" cy="34" r="1.5" fill="currentColor" opacity=".7"/></svg>',
...
'torch':'<svg viewBox="0 0 80 80"><rect x="36" y="56" width="8" height="8" rx="2" fill="currentColor" opacity=".5"/><path d="M34 56c-2-8-6-16-6-16M40 56c0-10 0-18 0-18M46 56c2-8 6-16 6-16" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><path d="M22 38c0-3 4-5 6-5 3 0 5 2 5 5s-2 5-5 5c-3 0-6-2-6-5z" fill="currentColor"/><path d="M35 36c0-3 2-5 5-5s5 2 5 5-2 5-5 5-5-2-5-5z" fill="currentColor"/><path d="M47 38c0-3 3-5 6-5s6 2 6 5-3 5-6 5-6-2-6-5z" fill="currentColor"/><path d="M24 36c1-1 3-2 4-2M37 34c1-1 2-2 3-2M49 36c1-1 3-2 4-2" stroke="#fff" stroke-width="1.5" opacity=".3" stroke-linecap="round"/></svg>',
'plate':'<svg viewBox="0 0 80 80"><ellipse cx="40" cy="44" rx="24" ry="10" fill="currentColor" opacity=".5"/><ellipse cx="40" cy="42" rx="22" ry="9" fill="currentColor"/><ellipse cx="40" cy="40" rx="20" ry="8" fill="currentColor"/><path d="M22 40c6 2 11 3 18 3s12-1 18-3" stroke="#fff" stroke-width="1" opacity=".2" fill="none"/><ellipse cx="40" cy="38" rx="6" ry="3" fill="#fff" opacity=".15"/><path d="M28 42c2-1 4-2 6-2M46 42c2 0 4 1 6 2" stroke="#fff" stroke-width=".8" opacity=".15" fill="none"/></svg>',
'carpet':'<svg viewBox="0 0 80 80"><rect x="12" y="48" width="56" height="12" rx="5" fill="currentColor" opacity=".4"/><path d="M14 48c4-2 8-3 12-3 5 0 9 2 14 2s9-2 14-2c4 0 8 1 12 3" fill="currentColor"/><path d="M16 46c3-1 7-2 11-2 5 0 8 2 13 2s8-2 13-2c4 0 8 1 11 2" fill="currentColor" opacity=".8"/><path d="M18 44c4-1 7-1 10-1 4 0 7 1 12 1s8-1 12-1c3 0 6 0 10 1" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none" opacity=".6"/><path d="M22 42c3 0 6 1 9 1s7-1 9-1 6 1 9 1 6-1 9-1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" fill="none" opacity=".4"/></svg>',
