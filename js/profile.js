...
'sps':'<svg viewBox="0 0 80 80"><path d="M40 30v26M32 32c2 10 4 22 4 22M48 32c-2 10-4 22-4 22M26 34c3 8 8 20 8 20M54 34c-3 8-8 20-8 20" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" opacity=".7"/><g fill="currentColor" opacity=".85"><circle cx="40" cy="28" r="5"/><circle cx="32" cy="30" r="4.5"/><circle cx="48" cy="30" r="4.5"/><circle cx="26" cy="32" r="4"/><circle cx="54" cy="32" r="4"/></g><g stroke="#fff" stroke-width="1" opacity=".5" stroke-linecap="round"><path d="M40 24v4m-2-2h4"/><path d="M32 26v4m-2-2h4"/><path d="M48 26v4m-2-2h4"/><path d="M26 28v4m-2-2h4"/><path d="M54 28v4m-2-2h4"/></g></svg>',
...
'mushroom':'<svg viewBox="0 0 80 80"><path d="M18 44c0-10 10-18 22-18 13 0 22 8 22 18 0 6-4 10-10 12-4 1-8 2-12 2-5 0-9-1-13-2-5-2-9-6-9-12z" fill="currentColor"/><path d="M20 42c1-8 10-14 20-14 11 0 19 6 20 14" fill="#fff" opacity=".15"/><path d="M25 44c4 1 9 2 15 2s12-1 16-3" stroke="currentColor" stroke-width="1.5" opacity=".3" fill="none"/><path d="M28 48c3 2 7 3 12 3s10-1 13-3" stroke="currentColor" stroke-width="1" opacity=".2" fill="none"/><ellipse cx="42" cy="56" rx="8" ry="3" fill="currentColor" opacity=".4"/></svg>',
...
'anemone':'<svg viewBox="0 0 80 80"><path d="M30 62c0-2 4-4 10-4s10 2 10 4v4H30v-4z" fill="currentColor" opacity=".5"/><path d="M32 58c-1-6-3-10-3-10M36 56c0-8-1-14-1-14M40 55c0-8 0-15 0-15M44 56c0-8 1-14 1-14M48 58c1-6 3-10 3-10M28 60c-2-5-5-8-5-8M52 60c2-5 5-8 5-8" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><circle cx="29" cy="46" r="4" fill="currentColor"/><circle cx="35" cy="40" r="4.5" fill="currentColor"/><circle cx="40" cy="38" r="5" fill="currentColor"/><circle cx="45" cy="40" r="4.5" fill="currentColor"/><circle cx="51" cy="46" r="4" fill="currentColor"/><circle cx="23" cy="50" r="3.5" fill="currentColor"/><circle cx="57" cy="50" r="3.5" fill="currentColor"/><circle cx="40" cy="37" r="2.5" fill="#fff" opacity=".3"/><circle cx="35" cy="39" r="2" fill="#fff" opacity=".25"/><circle cx="45" cy="39" r="2" fill="#fff" opacity=".25"/></svg>',
'gorgonian':'<svg viewBox="0 0 80 80"><ellipse cx="40" cy="62" rx="5" ry="3" fill="currentColor" opacity=".3"/><g stroke="currentColor" stroke-linecap="round" fill="none"><path d="M40 60C30 46 14 28 6 16" stroke-width="1.8" opacity=".4"/><path d="M40 60C26 50 10 36 2 24" stroke-width="1.4" opacity=".3"/><path d="M40 60C34 42 22 20 16 4" stroke-width="1.8" opacity=".38"/><path d="M40 60C36 38 28 14 26 2" stroke-width="1.6" opacity=".34"/><path d="M40 60C38 34 34 8 34 0" stroke-width="1.8" opacity=".4"/><path d="M40 60C39 30 38 6 38 0" stroke-width="1.4" opacity=".3"/><path d="M40 60C40 28 40 4 40 0" stroke-width="2" opacity=".42"/><path d="M40 60C42 36 48 18 52 8" stroke-width="1.6" opacity=".34"/><path d="M40 60C44 44 56 26 62 16" stroke-width="1.8" opacity=".36"/><path d="M40 60C48 48 64 36 72 26" stroke-width="1.2" opacity=".24"/><path d="M40 60C36 50 28 38 18 26" stroke-width="1.2" opacity=".24"/><path d="M40 60C38 46 32 22 28 6" stroke-width="1.2" opacity=".22"/><path d="M40 60C38 52 44 36 50 20" stroke-width="1" opacity=".18"/><path d="M40 60C42 52 36 36 30 20" stroke-width="1" opacity=".18"/></g><g fill="currentColor" opacity=".5"><circle cx="6" cy="15" r="3"/><circle cx="2" cy="23" r="2.5"/><circle cx="16" cy="3" r="3"/><circle cx="26" cy="1" r="3"/><circle cx="34" cy="0" r="3"/><circle cx="40" cy="0" r="3.2"/><circle cx="52" cy="7" r="2.8"/><circle cx="62" cy="15" r="2.8"/><circle cx="72" cy="25" r="2.2"/><circle cx="18" cy="25" r="2.2"/><circle cx="28" cy="5" r="2.5"/><circle cx="50" cy="19" r="2"/><circle cx="30" cy="19" r="2"/></g><g fill="#fff" opacity=".15"><circle cx="6" cy="14" r="1"/><circle cx="16" cy="2" r="1.2"/><circle cx="40" cy="0" r="1.5"/><circle cx="52" cy="6" r="1"/></g></svg>',
'brain':'<svg viewBox="0 0 80 80"><ellipse cx="40" cy="42" rx="20" ry="16" fill="currentColor"/><ellipse cx="40" cy="40" rx="18" ry="14" fill="currentColor"/><path d="M28 36c4 3 8 4 12 4s8-1 12-4M26 42c5 3 9 5 14 5s9-2 14-5M28 48c4 2 8 3 12 3s8-1 12-3" stroke="#fff" stroke-width="1.8" opacity=".25" fill="none"/><path d="M34 32c2 2 4 3 6 3s4-1 6-3M32 52c3 1 5 2 8 2s5-1 8-2" stroke="#fff" stroke-width="1.2" opacity=".2" fill="none"/><ellipse cx="40" cy="40" rx="18" ry="14" fill="none" stroke="#fff" stroke-width=".8" opacity=".15"/></svg>',
'torch':'<svg viewBox="0 0 80 80"><ellipse cx="40" cy="58" rx="4" ry="3" fill="currentColor" opacity=".35"/><path d="M40 58C34 50 24 40 18 34M40 58C30 48 18 38 14 30M40 58C36 46 26 32 22 26M40 58C38 44 30 26 28 20M40 58C39 40 34 24 32 18M40 58C40 36 38 20 38 14M40 58C40 38 42 22 42 16M40 58C41 40 44 24 46 18M40 58C42 44 48 30 52 24M40 58C44 48 54 38 58 32M40 58C48 52 58 44 62 38M40 58C36 52 26 42 22 36" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" fill="none" opacity=".4"/><g fill="currentColor" opacity=".6"><circle cx="18" cy="33" r="3"/><circle cx="14" cy="29" r="2.8"/><circle cx="22" cy="25" r="3"/><circle cx="28" cy="19" r="3"/><circle cx="32" cy="17" r="3"/><circle cx="38" cy="13" r="3.2"/><circle cx="42" cy="15" r="3"/><circle cx="46" cy="17" r="2.8"/><circle cx="52" cy="23" r="3"/><circle cx="58" cy="31" r="2.8"/><circle cx="62" cy="37" r="2.5"/><circle cx="22" cy="35" r="2.5"/><circle cx="28" cy="23" r="2.5"/><circle cx="50" cy="21" r="2.5"/></g><g fill="#fff" opacity=".18"><circle cx="18" cy="32" r="1"/><circle cx="28" cy="18" r="1.2"/><circle cx="38" cy="12" r="1.2"/><circle cx="52" cy="22" r="1"/></g></svg>',
'plate':'<svg viewBox="0 0 80 80"><ellipse cx="40" cy="46" rx="22" ry="8" fill="currentColor" opacity=".6"/><ellipse cx="40" cy="44" rx="22" ry="8" fill="currentColor"/><ellipse cx="40" cy="42" rx="20" ry="6" fill="currentColor"/><ellipse cx="40" cy="41" rx="16" ry="4" fill="#fff" opacity=".1"/><circle cx="32" cy="42" r="1.5" fill="#fff" opacity=".2"/><circle cx="38" cy="40" r="1.5" fill="#fff" opacity=".2"/><circle cx="44" cy="41" r="1.5" fill="#fff" opacity=".2"/><circle cx="50" cy="43" r="1.5" fill="#fff" opacity=".2"/><circle cx="36" cy="44" r="1" fill="#fff" opacity=".15"/><circle cx="46" cy="44" r="1" fill="#fff" opacity=".15"/></svg>',
'carpet':'<svg viewBox="0 0 80 80"><rect x="12" y="40" width="56" height="8" rx="4" fill="currentColor" opacity=".4"/><g stroke="currentColor" stroke-width="1.3" stroke-linecap="round"><path d="M16 40v-6m4 6v-8m4 8v-7m4 7v-8m4 8v-6m4 6v-8m4 8v-7m4 7v-8m4 8v-6m4 6v-8m4 8v-7m4 7v-8m4 8v-6"/><path d="M18 40v-5m4 5v-7m4 7v-6m4 6v-7m4 7v-5m4 5v-7m4 7v-6m4 6v-7m4 7v-5m4 5v-7m4 7v-6m4 6v-7"/></g><g fill="currentColor" opacity=".45"><circle cx="16" cy="33" r=".7"/><circle cx="20" cy="31" r=".7"/><circle cx="24" cy="32" r=".7"/><circle cx="28" cy="31" r=".7"/><circle cx="32" cy="33" r=".7"/><circle cx="36" cy="31" r=".7"/><circle cx="40" cy="32" r=".7"/><circle cx="44" cy="31" r=".7"/><circle cx="48" cy="33" r=".7"/><circle cx="52" cy="31" r=".7"/><circle cx="56" cy="32" r=".7"/><circle cx="60" cy="33" r=".7"/></g></svg>',
...
function _showInvDetail(){
  ...
  // Type dot colors
  const typeLabel={up:'\u589e\u503c',dead:'\u6b7b\u4ea1',down:'\u8d2c\u503c',broken:'\u635f\u574f',used:'\u6d88\u8017'};
  function renderList(items,cls){
    let h='';
    items.forEach(g=>{
      const label='<span class="inv-detail-type '+g.type+'">'+typeLabel[g.type]+'</span>';
      const name=g.name+(g.cnt>1?' \u00d7'+g.cnt:'');
      const sign=cls==='gain'?'+':'';
      h+='<div class="inv-detail-row">'+label+'<span class="inv-detail-name">'+name+'</span><span class="inv-detail-val '+cls+'">'+sign+Math.abs(g.val).toFixed(0)+'</span></div>';
    });
    return h;
  }
  ...
  if(gains.length){h+=renderList(gains,'gain');}
  ...
  if(losses.length){h+=renderList(losses,'loss');}
  else{h+='<div class="inv-detail-empty">\u6682\u65e0</div>';}
  h+='</div>';
  h+='</div></div></div>';
...
const IF_FIELDS={
  livestock:[
    ...
    {key:'price',label:'购入价格',type:'number',placeholder:'¥'},
